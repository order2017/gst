    ...
    <div class="bd">
        ...
        <div class="weui_grids">
            <a href="{{ url('/article-view?type_id=3') }}" class="weui_grid" style="padding: 5px;">
                <div class="weui_grid_icon" style="width: 100%; height: 80px; background-color: #f3cb71; text-align: center;">
            ...
            <a href="{{ url('/article-view?type_id=4') }}" class="weui_grid" style="padding: 5px;">
                <div class="weui_grid_icon" style="width: 100%; height: 80px; background-color: #98d08c; text-align: center;">
            ...
            <a href="{{ url('/article-view?type_id=6') }}" class="weui_grid" style="padding: 5px;">
                <div class="weui_grid_icon" style="width: 100%; height: 80px; background-color: #f15a24; text-align: center;">
                    <p style="padding-top: 30px; color: #fff;">
                        商业买卖
                    </p>
                </div>
