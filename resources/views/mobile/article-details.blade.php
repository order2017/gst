                                ...
                                @if(session()->has('mobile_user'))
                                    ...
                                    @if($userData['user_money']>=1)
                                        ...
                                        if($_GET['type_id']==3){ // 看商场招商信息收费10元一次，
                                            \App\User::where('user_id',$userData['user_id'])->update(['user_money'=>($userData['user_money']-1)]);
                                    ...
                                    @else
                                        ...
                                        <div class="weui_cells_title" style="color:red;" onclick="javascript:window.location='/user-qrcode'">充值10元 、立即查看联系咨询服务！</div>
                                    @endif
                                @else
